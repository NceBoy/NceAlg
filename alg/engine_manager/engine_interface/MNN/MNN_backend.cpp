...
namespace nce_alg
{
    ...
    public:
        ...
        NCE_S32 inference(img_t & image_data)
        {
            ...
            for (auto &kv : all_tensor.input_tensors_map)
            {
                ...
                pprocessor->convert(image_data.image, image_data.image_attr.u32Width, image_data.image_attr.u32Height, 0, kv.second);
    ...
    NCE_S32 MNN_engine::engine_init(const param_info & st_param_info, img_info & st_img_info, map<int, tmp_map_result> & st_result_map)
    {
