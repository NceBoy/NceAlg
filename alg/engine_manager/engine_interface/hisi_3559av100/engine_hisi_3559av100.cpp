...
namespace nce_alg
{
    ...
    NCE_S32 hisi_3559av100_engine::engine_init(const param_info & st_param_info, img_info & st_img_info, map<int, tmp_map_result> & st_result_map)
    {
        HI_S32 s32Ret = HI_SUCCESS;
    ...
    NCE_S32 hisi_3559av100_engine::engine_get_result(map<int, tmp_map_result> & st_engine_result)
    {
