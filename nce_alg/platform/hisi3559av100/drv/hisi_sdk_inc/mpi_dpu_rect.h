...
HI_S32 HI_MPI_DPU_RECT_SetChnAttr(DPU_RECT_GRP DpuRectGrp, DPU_RECT_CHN DpuRectChn, const DPU_RECT_CHN_ATTR_S *pstChnAttr);
HI_S32 HI_MPI_DPU_RECT_GetChnAttr(DPU_RECT_GRP DpuRectGrp, DPU_RECT_CHN DpuRectChn, DPU_RECT_CHN_ATTR_S *pstChnAttr);
...
HI_S32 HI_MPI_DPU_RECT_ReleaseFrame(DPU_RECT_GRP DpuRectGrp,const VIDEO_FRAME_INFO_S *pstSrcLeftFrame,
    const VIDEO_FRAME_INFO_S *pstSrcRightFrame, const VIDEO_FRAME_INFO_S *pstDstLeftFrame,
    const VIDEO_FRAME_INFO_S *pstDstRightFrame);
