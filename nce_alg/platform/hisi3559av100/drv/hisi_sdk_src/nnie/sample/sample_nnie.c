    ...
    SAMPLE_SVP_NNIE_PARAM_S *pstNnieParam, SAMPLE_SVP_NNIE_INPUT_DATA_INDEX_S* pstInputDataIdx)
{
    ...
    else
    {
        ...
        u32Stride = pstNnieParam->astSegData[u32SegIdx].astSrc[u32NodeIdx].u32Stride;
        pu8PicAddr = (HI_U8*)(pstNnieParam->astSegData[u32SegIdx].astSrc[u32NodeIdx].u64VirAddr);
		printf("w= %d,h=%d,chn=%d,stride = %d\n",u32Width,u32Height,u32Chn,u32Stride);
...
void SAMPLE_SVP_NNIE_Cnn(void)
{
  ...
  //  HI_CHAR *pcSrcFile = "./data/nnie_image/rgb_planar/cat_224x224.bgr";
  //  HI_CHAR *pcModelName = "./data/nnie_model/classification/mobilenet_v2_inst.wk";
    HI_U32 u32PicNum = 1;
    HI_S32 s32Ret = HI_SUCCESS;
    ...
    SAMPLE_SVP_NNIE_PARAM_S *pstNnieParam, SAMPLE_SVP_NNIE_YOLOV3_SOFTWARE_PARAM_S* pstSoftWareParam)
{
    ...
    pstSoftWareParam->u32ClassNum = 80;     	  //类的数目
    pstSoftWareParam->au32GridNumHeight[0] = 13;  //图片大小/32 (例：416/32)
...
void SAMPLE_SVP_NNIE_NTCNN()
{
	
	HI_CHAR *pcSrcFile = "./data/nnie_image/rgb_planar/horse_dog_car_person_224x224.bgr";
	HI_CHAR *pcModelName = "./data/nnie_model/detection/12net_mtcnn_inst.wk";
	HI_U32 u32PicNum =1;
	HI_FLOAT f32PrintResultThresh = 0.0f;
	HI_S32 s32Ret = HI_SUCCESS;
	HI_U32 i = 0;
