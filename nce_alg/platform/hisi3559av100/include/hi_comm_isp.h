...
{
    HI_U8   u8MeshScale;       /*RW; Range:[0, 7];Format:3.0;Three bit value that selects the scale and precision for the 10 bit gain coefficients stored in mesh tables*/
    HI_U16  au16XGridWidth[(HI_ISP_LSC_GRID_COL - 1) / 2];/*RW; Range:[4, 16323];limited Range:[4, u16ImgWidth /4 - 60],Member used to store the width data of each GRID partition*/
    HI_U16  au16YGridWidth[(HI_ISP_LSC_GRID_ROW - 1) / 2];/*RW; Range:[4, 16323];limited Range:[4, u16ImgHeight /4 - 60],Member used to store the height data of each GRID partition*/
...
typedef struct hiISP_NR_ATTR_S
{
    ...
    HI_U8    u8BnrLscMaxGain;                             /*RW;Range:[0x0,0xbf];Format:2.6; Max gain for referring to lens shading;  not support*/
...
typedef struct hiISP_CR_ATTR_S
{
    ...
    HI_U8    u8Slope;                   /* RW; Range: [0, 14];Crosstalk slope value.*/
    HI_U8    u8SensiSlope;              /* RW; Range: [0, 14];Crosstalk sensitivity.*/
    HI_U16   u16SensiThr;               /* RW; Range: [0, 16383];Crosstalk sensitivity threshold.*/
    HI_U16   au16Strength[ISP_AUTO_ISO_STRENGTH_NUM];   /* RW; Range: [0, 256];Crosstalk strength value.*/
    HI_U16   au16Threshold[ISP_AUTO_ISO_STRENGTH_NUM];  /* RW; Range: [0, 16383];Crosstalk threshold.*/
    HI_U16   au16NpOffset[ISP_AUTO_ISO_STRENGTH_NUM];   /* RW; Range: [512, 16383];Set Noise profile value.*/
} ISP_CR_ATTR_S;
...
typedef struct hiISP_AE_CROP_S
{
    ...
    HI_U16              u16X;       /* RW; Range: [0, 8192 - 256]; Format:13.0;AE image crop start x, limited range:[0, ImageWidth - 256] */
    HI_U16              u16Y;       /* RW; Range: [0, 8192 - 120]; Format:13.0;AEimage crop start y, limited range:[0, ImageHeight - 120]  */
    HI_U16              u16W;       /* RW; Range: [256, 8192]; Format:14.0;AE image crop width,  limited range:[256, ImageWidth] */
    HI_U16              u16H;       /* RW; Range: [120, 8192]; Format:14.0;AE image crop height  limited range:[120, ImageHeight] */
} ISP_AE_CROP_S;
...
typedef struct hiISP_AF_CROP_S
{
    ...
    HI_U16              u16X;       /* RW; Range: [0, 8192 - 256]; Format:13.0;AF image crop start x, limited range:[0, ImageWidth - 256]*/
    HI_U16              u16Y;       /* RW; Range: [0, 8192 - 120]; Format:13.0;AF image crop start y, limited range:[0, ImageHeight -120] */
    HI_U16              u16W;       /* RW; Range: [256, 8192]; Format:14.0;AF image crop width, limited range:[256, ImageWidth]*/
    HI_U16              u16H;       /* RW; Range: [120, 8192]; Format:14.0;AF image crop height, limited range:[120, ImageHeight]*/
} ISP_AF_CROP_S;
...
typedef struct hiISP_AF_CFG_S
{
    ...
    HI_U16                  u16Hsize;       /* RW; Range: [256, 8192]; limited Range: [256, ImageWidth],AF image width.*/
    HI_U16                  u16Vsize;       /* RW; Range: [120, 8192]; limited Range: [120, ImageHeight],AF image height.*/
...
typedef struct hiISP_AWB_CROP_S
{
    ...
    HI_U16   u16X;      /* RW; Range: [0, 8192 - 60]; Format:13.0;AWB image crop start x, limited range:[0, ImageWidth - u16ZoneCol * 60]*/
    HI_U16   u16Y;      /* RW; Range: [0, 8192 - 14]; Format:13.0;AWB image crop start y,limited range:[0, ImageHeight - u16ZoneRow * 14] */
    HI_U16   u16W;      /* RW; Range: [60, 8192]; Format:14.0;AWB image crop width, limited range:[u16ZoneCol * 60, ImageWidth]*/
    HI_U16   u16H;      /* RW; Range: [14, 8192]; Format:14.0;AWB image crop height, limited range:[u16ZoneRow * 14, ImageHeight]*/
} ISP_AWB_CROP_S;
