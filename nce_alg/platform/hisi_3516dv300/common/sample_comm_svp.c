...
HI_VOID SAMPLE_COMM_SVP_DestroyImage(SVP_IMAGE_S *pstImg,HI_U32 u32AddrOffset)
{
    if (NULL != pstImg)
    {
       ...
       {
         (HI_VOID)HI_MPI_SYS_MmzFree(pstImg->au64PhyAddr[0] - u32AddrOffset, (void *) (HI_UL)(pstImg->au64VirAddr[0] - u32AddrOffset));
       }
...
HI_VOID SAMPLE_COMM_SVP_DestroyMemInfo(SVP_MEM_INFO_S *pstMemInfo,HI_U32 u32AddrOffset)
{
    if (NULL != pstMemInfo)
    {
       ...
       {
         (HI_VOID)HI_MPI_SYS_MmzFree(pstMemInfo->u64PhyAddr - u32AddrOffset, (void *) ((HI_UL)pstMemInfo->u64VirAddr - u32AddrOffset));
       }
