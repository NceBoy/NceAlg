#ifndef __RP_LCD_MIPI_5INCH_480X854_H__
#define __RP_LCD_MIPI_5INCH_480X854_H__
#include "sample_comm.h"
#include "hi_mipi_tx.h"

/*============================= mipi 5 inch 480x854 lcd config ====================================*/
combo_dev_cfg_t MIPI_TX_5INCH_480X854_60_CONFIG =
{
    .devno = 0,
    .lane_id = {0, 1, 2, 3},
...
VO_SYNC_INFO_S MIPI_TX_5INCH_480X854_60_SYNC_INFO = 
{
	.u16Hact	= 800,
	.u16Hbb		= 36,
	.u16Hfb		= 18,
...
VO_USER_INTFSYNC_INFO_S MIPI_TX_5INCH_480X854_60_USER_INTFSYNC_INFO = 
{
	.stUserIntfSyncAttr = 
	{
		.stUserSyncPll	= 
...
lcd_resoluton_t MIPI_TX_5INCH_480X854_60_LCD_RESOLUTION = 
{
	.pu32W	= 480,
	.pu32H	= 854,
	.pu32Frm= 60,
...
HI_VOID InitScreen_mipi_5inch_480x854(HI_S32 s32fd)
{
    HI_S32     fd     = s32fd;
    HI_S32     s32Ret;
    HI_U8      cmd[30];
...
#endif /* End of #ifndef __RP_LCD_MIPI_5INCH_480X854_H__*/
